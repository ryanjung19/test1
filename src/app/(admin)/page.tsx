    ...
    <div className="page-wrap">
      <header className="page-header">
        ...
        <div className="header-actions">
          <a className="button secondary button-link" href="/reserve" target="_blank" rel="noreferrer">고객 예약 화면</a>
      ...
      <div className="content-grid">
        <section className="panel panel-wide">
          <div className="panel-heading">
            ...
            <a className="pill" href="/calendar">캘린더 열기</a>
          </div>
          ...
          <div className="schedule-board">
            ...
            <div className="space-row">
              <strong>1F</strong>
              <div className="timeline empty-timeline"><span>실시간 일정은 Calendar에서 확인</span></div>
            </div>
            <div className="space-row">
              <strong>B1</strong>
              <div className="timeline empty-timeline"><span>실시간 일정은 Calendar에서 확인</span></div>
      ...
      <div className="content-grid lower-grid">
        <section className="panel">
          ...
          <ul className="system-list">
            <li><span>홈페이지 예약 모듈</span><strong>/reserve</strong></li>
            <li><span>기존 챗봇</span><strong>Booking API</strong></li>
            <li><span>전화 · 이메일</span><strong>Interaction 모델</strong></li>
            <li><span>카카오채널 / SNS</span><strong>Adapter 예정</strong></li>
          </ul>
        </section>
